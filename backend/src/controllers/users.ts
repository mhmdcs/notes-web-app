...
export const signUp: RequestHandler<unknown, unknown, CreateUserBody, unknown> = async (request, response, next) => {
    ...
    try {
        ...
        // we don't want to save the raw password to the database, because even if the database is locked with a password, there can always be something bad happening like an attack or a leak to the database, you don't want to risk leaking the raw passwords of all your users unless you don't care about your reputation
